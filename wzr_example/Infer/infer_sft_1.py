...
campus_path = "/root/PKU/campus"
infer_path = "./val_campus"
...
for video_id in range(1, 15):
    for action_id in range(len(actions)) :
        ...
        if os.path.exists(save_path):
            continue
        # if video_id!=14 or actions[action_id]!="go straight":
        #     continue
        image = load_image(os.path.join(campus_path, f"{video_id}.jpg"))
...
vista_demo_path = "/root/PKU/vista_demos"
