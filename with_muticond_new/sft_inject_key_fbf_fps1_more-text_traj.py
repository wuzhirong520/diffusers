...
def main(args):
    ...
    train_dataset = NuscenesDatasetFPS1OneByOneTrajectoryForCogvidx(
    ...
    def collate_fn(examples):
        ...
        trajs = [example["trajectory"].to(accelerator.device) for example in examples]
        trajs = torch.cat(trajs)
